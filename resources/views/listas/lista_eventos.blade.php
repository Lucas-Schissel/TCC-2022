		...
		@foreach ($eve as $u)
		  <tr class="table-light" >
			...
			<td>
			 ...
			 <a class="btn btn-warning mt-1" href="{{ route('evento_update', [ 'id' => $u->id ])}}"> 
			 Alterar
...
<div class= "row">
	<div class="navbar-expand-lg navbar navbar-dark bg-dark w-100">
		...
		<a class="btn btn-secondary m-1 p-1" type="button2" href="{{ route('evento_cadastro') }}">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		Deseja realmente excluir o evento, <span class="nome"></span>?
...
<script>
	$('.delete').on('click', function(){
		...
		var id = $(this).data('id'); 
		$('span.nome').text(nome); 
		$('a.delete-yes').attr('href', '/evento/excluir/' +id); 
		$('#excluir').modal('show');
	});
</script>
